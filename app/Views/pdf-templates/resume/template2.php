...
<body>
    ...
    <table style="margin-bottom:15px;">
        ...
        <tr>
            <td colspan="2">
            <label class="heading-2 h4 heading" style="margin-top: 15px;">About Me</label>
        ...
        <div class="left">
            ...
            <div class="technical-skills">
                <label class="heading-4 h4 sub-heading">Technical Skills</label>
                            ...
                            <?php foreach ($joiningFormDetails['professional_qualification'] as $p_qualification) { ?>
                                <table class="table courses">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="12">
                                                <label class="heading-6 h6 sub-heading"><?= $p_qualification['date'] ?></label>
                                            </td>
                            ...
                            <div class="container-1">
                                ...
                                <?php foreach ($joiningFormDetails['projects'] as $e_qualification) { ?>
                                    <div style="margin-bottom:15px;padding-left:10px;">
                                        <label class="heading-5 h5 sub-heading"><?= $e_qualification['title'] ?></label>
                                        <div>
