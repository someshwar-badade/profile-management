            ...
            <div class="col-md-10 offset-md-1">
                <div class="card card-primary">
                    <nav class="navbar navbar-expand sticky-form-header">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url(route_to('sendJoiningForm')) ?>" class="btn btn-sm btn-secondary ml-2">Cancel</a>
              ...
              <div class="col-sm-9">
                ...
                <div class="text-danger" ng-show="errors.candidate_name">{{errors.candidate_name}}</div>
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="firstName" ng-model="profile.first_name" maxlength="100" name="first_name" class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="lastName" ng-model="profile.last_name" maxlength="100" name="last_name" class="form-control">
                                <div class="text-danger" ng-show="errors.last_name">{{errors.last_name}}</div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3" for="inputName">Father Name <sup class="text-danger">*</sup></label>
                            <div class="col-sm-9">
                                <input type="text" id="fatherName" ng-model="profile.father_name" maxlength="100" name="father_name" class="form-control">
                                <div class="text-danger" ng-show="errors.father_name">{{errors.father_name}}</div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3" for="inputName">Mother Name <sup class="text-danger">*</sup></label>
                            <div class="col-sm-9">
                                <input type="text" id="motherName" ng-model="profile.mother_name" maxlength="100" name="mother_name" class="form-control">
                                <div class="text-danger" ng-show="errors.mother_name">{{errors.mother_name}}</div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3" for="inputName">Spouse Name <sup class="text-danger">*</sup></label>
                            <div class="col-sm-9">
                                <input type="text" id="spouseName" ng-model="profile.spouse_name" maxlength="100" name="spouse_name" class="form-control">
                                <div class="text-danger" ng-show="errors.spouse_name">{{errors.spouse_name}}</div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3" for="inputName">Kids Name <sup class="text-danger">*</sup></label>
                            <div class="col-sm-9">
                                <input type="text" id="kidsName" ng-model="profile.kids_name" maxlength="100" name="kids_name" class="form-control">
                                <div class="text-danger" ng-show="errors.kids_name">{{errors.kids_name}}</div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="email" id="aadharNumber" ng-model="profile.aadhar_number" maxlength="100" name="aadhar_number" class="form-control">
                                <div class="text-danger" ng-show="errors.aadhar_number">{{errors.aadhar_number}}</div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3" for="inputName">PAN Card Number <sup class="text-danger">*</sup></label>
                            <div class="col-sm-9">
                                <input type="email" id="panNumber" ng-model="profile.pan_number" maxlength="100" name="pan_number" class="form-control">
...
<script>
    app.controller('addProfileCtrl', ['$scope', '$http', 'slugifyFilter', function($scope, $http, slugifyFilter) {
        ...
        $scope.submitClick = function() {
            ...
            var apiUrl = base_url + '/api/joining-form-list';
            var method = "POST";

            if ($scope.profile.id) {
                apiUrl = base_url + '/api/joining-form-list/' + $scope.profile.id;
        ...
        $http({
            method: 'get',
            url: base_url + '/api/joining-form-list/' + '<?= $id ? $id : '0' ?>',
        }).then(function(response) {
