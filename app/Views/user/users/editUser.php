                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-check">
                          ...
                          <label class="form-check-label"><input class="form-check-input" type="checkbox" ng-model="user.changePassword" > Change Password</label>
                        </div>
                    </div>
                  </div>

                  <div class="form-group row" ng-show="user.changePassword">
