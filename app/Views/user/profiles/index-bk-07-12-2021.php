            ...
            <div class="modal-dialog modal-lg mw-100">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div ng-show="profile.primary_skills.length" class="form-group row">
                            <label class="col-sm-3" for="topSkills">Top Skills</label>
                            <div class="col-sm-9">
                                <span class="badge badge-secondary ml-1" ng-repeat="skill in profile.primary_skills">{{skill}}</span>

                            </div>
                        </div>

                        <div ng-show="profile.secondary_skills.length" class="form-group row">
                            <label class="col-sm-3" for="middleSkills">Middle Skills</label>
                            <div class="col-sm-9">
                                <span class="badge badge-secondary ml-1" ng-repeat="skill in profile.secondary_skills">{{skill}}</span>
